  ...
  return (
    <div className="min-h-screen bg-[#050505] text-white">
      ...
      <div className="mx-auto flex max-w-2xl flex-col items-center px-6 py-24 text-center lg:px-10">
        {/* Checkmark */}
        <div className="flex h-20 w-20 items-center justify-center rounded-full bg-[#f4cf36]">
          <svg
        ...
        <div className="mt-10 w-full space-y-4 text-left">
          <div className="rounded-[24px] border border-[#f4cf36]/20 bg-[#14110a] p-6">
            <p className="text-sm font-medium uppercase tracking-[0.18em] text-[#f4cf36]">
              What happens next
            </p>
            <ul className="mt-4 space-y-3 text-sm leading-6 text-white/80">
              <li className="flex items-start gap-3">
                <span className="mt-0.5 flex h-5 w-5 flex-none items-center justify-center rounded-full bg-[#f4cf36] text-[10px] font-bold text-black">1</span>
                We'll email you a confirmation with your booking reference
              </li>
              <li className="flex items-start gap-3">
                <span className="mt-0.5 flex h-5 w-5 flex-none items-center justify-center rounded-full bg-[#f4cf36] text-[10px] font-bold text-black">2</span>
                Our team will reach out to confirm shoot time, access, and any property details
              </li>
              <li className="flex items-start gap-3">
                <span className="mt-0.5 flex h-5 w-5 flex-none items-center justify-center rounded-full bg-[#f4cf36] text-[10px] font-bold text-black">3</span>
          ...
          <div className="rounded-[24px] border border-[#f4cf36]/20 bg-[#14110a] p-6">
            ...
            <div className="mt-3 space-y-1">
              <a href="mailto:contact@mavncreative.com" className="block text-sm text-white transition hover:text-[#f4cf36]">
                contact@mavncreative.com
              </a>
              <a href="tel:6124883825" className="block text-sm text-white/70 transition hover:text-[#f4cf36]">
                (612) 488-3825
              </a>
            </div>
          </div>
        ...
        <a
          href="/"
          className="btn-press mt-10 rounded-2xl bg-[#f4cf36] px-8 py-3.5 text-sm font-semibold text-black"
        >
